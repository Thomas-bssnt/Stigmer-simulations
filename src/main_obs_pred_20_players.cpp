...
#pragma omp parallel for
        ...
        {
            Game game(numberOfRounds, 3, numberOfPlayers, Rule(RuleNumber::Rule2), Map(225 * 4, false), std::nan(""));
        ...
        analyzer.saveObservables(pathDataFigures + gameType + "model/predictions/20_players/");
    }
